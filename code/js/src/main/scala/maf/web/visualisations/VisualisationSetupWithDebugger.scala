...
import maf.modular.scheme.monadic.{Monolith, SimpleModFAnalysis}
...
trait VisualisationSetupWithDebugger:
  ...
  def setup() =
    ...
    input.setFile(ExamplePrograms1.factorial2)
